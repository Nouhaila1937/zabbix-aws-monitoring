...
- L'équipe AWS Academy pour la mise à disposition de l'environnement Lab
- La communauté Zabbix pour la documentation et le support
- [Votre établissement] pour la formation
...
- Configuration complète de Zabbix 6.4
- Monitoring de 3 machines (1 serveur + 2 clients)
- Documentation complète des problèmes rencontrés
